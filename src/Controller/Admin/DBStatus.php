            ...
            if ($this->P->cb_customdata['rows_orders_items'] > 0) {
                if ($C['vat_disable']) {
                    $aListSetting = [
                        ...
                        [
                            'title' => 'oi_price_brutto_list',
                            'key' => 'oi_price_brutto_list',
                            'width' => '9%',
                            'linked' => false,
                        ],
                        [
                            'title' => 'oi_price_brutto_sale',
                            'key' => 'oi_price_brutto_sale',
                            'width' => '9%',
                            'linked' => false,
                        ],
                        [
                            'title' => 'oi_price_brutto_rebated',
                            'key' => 'oi_price_brutto_rebated',
                            'width' => '9%',
                            'linked' => false,
                        ],
                        [
