...
itmg_id int(11) NOT NULL,
  ...
  itmg_imgsm varchar(256) NOT NULL,
  itmg_imglg varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
o_id int(11) NOT NULL,
  ...
  o_ordercompleted varchar(1) NOT NULL DEFAULT 'n',
